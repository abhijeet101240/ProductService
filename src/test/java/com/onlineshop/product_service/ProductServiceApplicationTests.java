...
class ProductServiceApplicationTests {
	...
	void shouldCreateProduct() throws Exception {
		List<ProductRequest> productRequest = getProductRequest();
	...
	private List<ProductRequest> getProductRequest() {
		...
		ProductRequest build2 =	ProductRequest.builder()
				.name("iphone 11")
				.description("iphone 11 , 256 gb")
				.price(BigDecimal.valueOf(122))
				.build();

		ProductRequest build3	= ProductRequest.builder()
				.name("iphone 11")
				.description("iphone 11 , 256 gb")
				.price(BigDecimal.valueOf(122))
				.build();

		List<ProductRequest> list = Arrays.asList(build1, build2, build3);
